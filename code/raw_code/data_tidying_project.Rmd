...
### This is the setup portion to load all the packages we need for our analysis
```{r setup, echo=TRUE}
...
### Joining the two datasets into one

```{r merge-data, warning=FALSE} 
## Now, combine the two data frames
df_total <- left_join(df_retail, df_department)
```
